...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleException(Exception exception) {
        ...
        if (exception instanceof UserRepeatException){
            // 用户模块错误异常
            UserRepeatException userRepeatException = (UserRepeatException) exception;
            resultVO = new ResultVO<>(userRepeatException.getCode(),userRepeatException.getMessage(),exception.toString());
            status = HttpStatus.resolve(userRepeatException.getCode());
